/*Print Distinct City from Table Customers and Print Count Distinct City from Table Customers*/
 ...
 /*Print name of the product which is present at the 5th position till the 15th position from Products table, use LIMIT 
keyword*/
 select ProductName from Products;
 
 /*Write a SQL query for all the details of the supplier whose name consists of “A” at the second position from the 
Suppliers table*/
 ...
 /*Print the details of all the orders which were placed between the year 2020 to 2021 also print the same in descending 
order
...
/*Write a query to show the distinct city and their count from the Customers table */
 ...
 /*Write a query to fetch details of all employees excluding the employees with first names, “Sanjay” and “Sonia” from the 
Employees table.*/
